    ...
    <header className="sticky top-0 z-10 bg-white/80 backdrop-blur-sm border-b border-slate-200 px-4 lg:px-8 py-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <button
            disabled
            className="flex items-center gap-2 px-3 py-2 text-sm font-medium text-slate-400 bg-slate-50 rounded-lg cursor-not-allowed"
          >
            <RefreshCw size={15} className="text-slate-500" />
            <span className="hidden sm:inline">同期未実装</span>
          </button>
